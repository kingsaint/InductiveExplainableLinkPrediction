...
class GAT(nn.Module):
    def __init__(self, kg, entity_dim, relation_dim, num_layers, num_heads, head_dim, dropout):
...
#gat = GAT(kg=dg, entity_dim=200, relation_dim=200, num_layers=2, num_heads=4, head_dim=200, dropout=0.3)
